      ...
      {card.map((c: any, index: any) => (
        <div className="card m-10" key={index}>
          ...
          >
            ...
            <h4>{c.name}</h4>
            <p
              style={{ fontSize: "1.2rem", padding: "0.5rem", height: "40%" }}
            ...
            <div className="flex justify-center m-1">
              <a href={c.web} target="_blank" rel="noreferrer">
                <button className="mx-2 bg-[#ffc23d] text-dark">
                  <img
                    src="https://icon-library.com/images/www-icon-vector/www-icon-vector-12.jpg"
                    style={{
                      height: "1.5rem",
                      width: "1.5rem",
                      marginRight: "0.3rem",
              ...
              <a href={c.git} target="_blank" rel="noreferrer">
                <button className="bg-[#ffc23d] text-dark">
                  <img
